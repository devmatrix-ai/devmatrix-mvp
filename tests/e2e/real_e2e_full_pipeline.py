...
"""
    ...
    async def _run_ir_smoke_test(self) -> Optional[SmokeTestResult]:
        ...
        try:
            ...
            print("    📝 Phase 1: Getting TestsModelIR from ApplicationIR...")

            # Check if TestsModelIR was auto-generated by SpecToApplicationIR
            # Only regenerate if empty (for cached IR without tests_model)
            if self.application_ir.tests_model and self.application_ir.tests_model.endpoint_suites:
                tests_model = self.application_ir.tests_model
                print("    ✅ Using auto-generated TestsModelIR from IR")
            else:
                # Regenerate for cached IR or if tests_model is empty
                tests_model = generate_tests_ir(self.application_ir)
                self.application_ir.tests_model = tests_model
                print("    🔄 Regenerated TestsModelIR (was empty or from cache)")
