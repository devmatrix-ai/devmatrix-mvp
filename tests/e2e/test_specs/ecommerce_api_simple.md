...
- Philosophy: Let the LLM discover what needs validation, don't pre-define lists

Configuration:
```yaml
validation_count: unlimited
minimum_required: 30
source: llm_extraction_only
note: "DO NOT manually list validations here. The LLM extracts the ground truth."
```
