...
class CartStateMachine(BaseStateMachine):
    """
    State machine for Cart entity.
    ...
    def __init__(self, initial_state: CartState = None):
        if initial_state is None:
            initial_state = CartState.INITIAL
        super().__init__(initial_state.value)
        self.state_enum = CartState
