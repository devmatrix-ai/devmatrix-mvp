"""
F3: View Product Details workflow implementation.

Get all information of a specific product by ID. If it doesn't exist, return Error 404
"""
import asyncio
import logging
...
class F3ViewProductDetailsWorkflow:
    """
    F3: View Product Details workflow.

    Trigger: User requests specific product by ID
    """

    def __init__(self):
        self.name = "F3: View Product Details"
    ...
    async def _execute_validate(self, step_num: int, context: WorkflowContext, **kwargs) -> Dict[str, Any]:
        ...
        Target: Product
        """
        self.logger.debug(f"Executing step {step_num}: Retrieve product details")
    ...
    async def _execute_validate(self, step_num: int, context: WorkflowContext, **kwargs) -> Dict[str, Any]:
        ...
        Target: Product
        """
        self.logger.debug(f"Executing step {step_num}: Return product information")
