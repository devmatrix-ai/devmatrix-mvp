...
class F17ViewOrderDetailsWorkflow:
    ...
    async def _execute_validate(self, step_num: int, context: WorkflowContext, **kwargs) -> Dict[str, Any]:
        ...
        Target: Order
        """
        self.logger.debug(f"Executing step {step_num}: Retrieve order with all items and details")
    ...
    async def _execute_validate(self, step_num: int, context: WorkflowContext, **kwargs) -> Dict[str, Any]:
        ...
        Target: Order
        """
        self.logger.debug(f"Executing step {step_num}: Return complete order information")
