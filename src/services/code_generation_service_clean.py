    ...
    async def _compose_patterns(
        ...
        **Phase 1 Refactoring**: Now accepts ApplicationIR as primary input with
        ...
        if os.getenv("PRODUCTION_MODE") == "true":
            ...
            # Use spec_requirements for generator (pass None for app_ir, it will use defaults)
...
"""
    ...
    def _generate_main_py(self, spec_requirements) -> str:
        ...
        """
        # Handle None spec_requirements (when called with ApplicationIR)
        entities_list = spec_requirements.entities if spec_requirements is not None else []
